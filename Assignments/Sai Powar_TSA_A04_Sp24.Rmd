...
#autoplot(ts_re_data,series="Original series")+ autolayer(dt_re_linear,series="Detrended") #+autolayer(diff_re_data,series="Differenced")+ ylab("Power")+ ggtitle("TotalRenewableEnergyProduction")
