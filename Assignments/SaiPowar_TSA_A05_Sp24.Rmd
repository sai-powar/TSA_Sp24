...
energy_data$Solar.Energy.Consumption = as.numeric(as.factor(energy_data$Solar.Energy.Consumption))
energy_data$Wind.Energy.Consumption = as.numeric(as.factor(energy_data$Wind.Energy.Consumption))
...
> Answer: The trend component isn't continuous throughout time in terms of an increasing or decreasing pattern. The production increases over time followed by sharp decreases, for example around 2008 and around 2020 for wind and around 2013 for solar. But, overall the production has increases since 1984. The random component still seems to have some seasonality and does not appear to be completely random because of the equally spaced patterns. 
...
> Answer: I don't see any difference in the clean and raw solar consumption series. For wind consumption, I see that some data was changed in the 2020 year.
