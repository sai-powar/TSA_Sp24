...
For biomass and hydroelectric, the linear trend still remains. However, for the hydroelectric consumption, removing the seasonal component changed the number of peaks and valleys indicating that the series does not have any seasonal variability and the remaining variability from another variable/reason. 
