...
Our data goes from January 2001 to November 2022. I will remove a couple rows randonly and show you how to detect missing rows.
...
SARIMA allows for a changing seasonal component over time. When removing the seasonal component, we are using a constant means method so we're using a constant component. 
But, some series will need for removal of linear and seasonal trends and then removing seasonal component and then fitting ARIMA might work. 
