...
```{r NNETAR, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
Note that a new accuracy measure appeared in the table. Theil's U is a relative accuracy measure that compares the forecasted results with the results of forecasting with minimal historical data.
